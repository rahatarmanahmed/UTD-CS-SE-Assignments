...
public class QuadraticProbingHashTable<AnyType>
{
    ...
    /**
     *	Get an item if it is in the table.
     *  @author Rahat Ahmed
     *	@param x the item to search for.
     *	@return the item.
     */
    ...
    /**
     * Returns a set of all items in this
     * table.
     * @author Rahat Ahmed
     * @return a set of all items this table contains
     */
    public Set<AnyType> toSet()
    {
    	Set<AnyType> set = new HashSet<AnyType>();
    	for(int k=0; k<array.length; k++)
    		if(isActive(k))
    			set.add(array[k].element);
    	return set;
    }
