...
namespace HuntTheWumpus3
{
    ...
    public class Game : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            concrete = Content.Load<Texture2D>("concrete");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //Camera camera = new Camera(this, new Vector3(0, 0, 10), new Vector3(0, 0, 0), Vector3.UnitY);
            //foreach (ModelMesh mesh in Game.sphere.Meshes)
            //{
            ...
            //        effect.Projection = Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(45), 1000/480, 0.1f, 3000f);
            //    }
            //    mesh.Draw();
            //}
            base.Draw(gameTime);
